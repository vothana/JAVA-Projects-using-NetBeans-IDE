...
private static void Message() {
                                                                                            ...
                                                                                            if( FileER.exists() ) {
                                                                                                                                              //messageText();
                                                                                                                                              System.out.println("Main.MainBT.Message()");
                                                                                            }else {
...
//pw.println(" procceed");
//pw.println("\t>>>> Maybe File : \"orginal.txt\" ");
...
//}
    ...
    pw.print("Date ៖ ");
    pw.print(dtf.format(now));
    pw.println(" procceed error...");
    pw.println("\t>>>> In File : orginal.txt has no data");
    pw.println("\t>>>> \"Please Check\"");
    pw.close();
                                                                                            } catch (IOException e) {
                                                                                                                                              e.printStackTrace();
                                                                                            }
